...
자유롭게 들어오시면 됩니다.\n얼른 들어오세요! 🙂\n ${zoomLink}`;
    ...
    if (today === "금") {
      let newMessage = "금일은 주간 위클리 설문이 있습니다!\n짧은 설문이니 수업 개선을 위한 필수 설문이니 모두가 꼭 참여해주세요!(*적극적으로 의견 적어주시면  감사하겠습니다!)\n ※위클리 설문 링크는 점심시간에 공지 하겠습니다!)"
      announcement += newMessage
    }
    return message.channel.send(`${message.author}, ${announcement}`);
